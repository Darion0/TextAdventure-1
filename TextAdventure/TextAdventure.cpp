...
int main()
{
	...
	while (userChoice != "q" && userChoice != "Q")
	{
		...
		if (location == "start")
		{
			std::cout << "Alright, " << name << ". You find your self in a dark room. There is a door to our North, South, East and West.\n";
			std::cin >> userChoice;
		...
		if (location == "north")
		{
			...
			if (userChoice == "start" || userChoice == "s")
			{
				location = "start";
			}
